...
<link rel="icon"type="image/x-icon" href="${pageContext.request.contextPath}/img/images.png">
...
<main class="form-signin w-100 m-auto">
    <form action="registerCategory" method="post">
        <img class="" src="${pageContext.request.contextPath}/img/image%20.jpg" alt="HOT" width="200">
        <h4 class="">HOT</h4>
        ...
        <p class="mt-3 mb-3 text-muted">Todos los Derechos Reservados HOT</p>
